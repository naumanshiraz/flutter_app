...
class OccupantsPage extends ConsumerStatefulWidget {
  ...
  const OccupantsPage({super.key, required this.propertyId});
...
class _OccupantsPageState extends ConsumerState<OccupantsPage> {
  ...
  Future<void> _onAddAffiliate() async {
    ...
    final notifier = ref.read(affiliatesProvider(widget.propertyId).notifier);
  ...
  Widget build(BuildContext context) {
    final state = ref.watch(affiliatesProvider(widget.propertyId));
    final notifier = ref.read(affiliatesProvider(widget.propertyId).notifier);
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GradientButton(label: 'Add an affiliate', isLoading: state.isSubmittingDraft, onPressed: _onAddAffiliate),
                  ],
                ),
              ),
            ),
